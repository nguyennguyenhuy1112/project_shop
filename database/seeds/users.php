...
class users extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('users')->insert([
            ['id'=>1,'email'=>'admin@gmail.com','password'=>bcrypt('123456'),'full'=>'admin','address'=>'Thường tín','phone'=>'0356653301','level'=>1],
            ['id'=>2,'email'=>'zimpro@gmail.com','password'=>bcrypt('123456'),'full'=>'Nguyễn thế vũ','address'=>'Bắc giang','phone'=>'0356654487','level'=>2],
            ['id'=>3,'email'=>'nhnguyen.111298@gmail.com','password'=>bcrypt('123456'),'full'=>'Nguyễn Huy Nguyên','address'=>'Hà Nội','phone'=>'0795039006','level'=>1],
